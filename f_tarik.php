...
// mysqli_query($conn, "CREATE VIEW datas AS SELECT a.*, b.t_kos, c.kamar, c.komplek FROM u9048253_psb22.tb_santri a JOIN u9048253_psb22.dekos b ON a.nis=b.nis JOIN u9048253_psb22.lemari_data c ON a.nis=c.nis WHERE a.ket = 'baru' ");
