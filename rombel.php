                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?= $r['nama'] ?></td>
                                                        <td><?= $r['tahun'] ?></td>
                                                        <td><a href="<?= 'hapus.php?kd=rmb&id=' . $r['id_rombel'] ?>" onclick="return confirm('Yakiin akan dihapus ?')"><button class="btn btn-danger btn-minier"><i class="fa fa-trash"></i> Dele</button></a></td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
                                        </table>
